...
#define fpga_dio_oe_set(bank, value) \
	fpga_poke32(0x40 + (bank * 0x1c) + 0x00, value)
#define fpga_dio_oe_clr(bank, value) \
	fpga_poke32(0x40 + (bank * 0x1c) + 0x04, value)

/* Output Data */
#define fpga_dio_dat_set(bank, value) \
	fpga_poke32(0x40 + (bank * 0x1c) + 0x08, value)
#define fpga_dio_dat_clr(bank, value) \
	fpga_poke32(0x40 + (bank * 0x1c) + 0x0c, value)

/* Output Data Readback */
#define fpga_dio_dat_out(bank) \
	fpga_peek32(0x40 + (bank * 0x1c) + 0x08)

/* Output Enable Data Readback */
#define fpga_dio_oe(bank) \
	fpga_peek32(0x40 + (bank * 0x1c) + 0x00)

/* Input Data */
#define fpga_dio_dat_in(bank) \
	fpga_peek32(0x40 + (bank * 0x1c) + 0x0c)
